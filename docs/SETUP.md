# Running and configuring Rolodex

[← Project overview](../README.md)

Detailed setup, configuration, and testing instructions.

## Start here

Install **Node.js 24 LTS**. Open this project folder in Cursor, VS Code, or your preferred editor, then open a terminal in the project root.
...
1. In your editor, duplicate `.env.example` and name the copy `.env`.
...
See the [project overview](../README.md) for the product walkthrough and design decisions.
